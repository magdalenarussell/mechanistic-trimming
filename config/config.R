...
WHOLE_NUCSEQS_parsimony = paste0(MOD_PROJECT_PATH,'/_ignore/tcrb_processed_geneseq.tsv')
WHOLE_NUCSEQS_alpha = paste0(MOD_PROJECT_PATH,'/_ignore/imgt_tcra_sequences.tsv')
WHOLE_NUCSEQS_gamma = paste0(MOD_PROJECT_PATH, '/_ignore/imgt_tcrg_sequences.tsv')
WHOLE_NUCSEQS_delta = paste0(MOD_PROJECT_PATH,'/_ignore/imgt_tcrd_sequences.tsv') 
