...
plot_predicted_trimming_dists <- function(data, gene_name, ylim = NULL, color = 'blue', motif_highlight = "CTT", motif_highlight_color = 'black', seq_text = 7, predictions = TRUE, write_plot = TRUE){
    ...
    plot_predicted_trimming_dists_single_group(data, gene_name, complete_path, ylim, color = color, motif_highlight_color = motif_highlight_color, motif_highlight = motif_highlight, predictions = predictions, write_plot = write_plot)
}
