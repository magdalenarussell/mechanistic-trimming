...
# get model types
orig_model_types = c('dna_shape-std', 'motif', 'distance', 'linear-distance', 'two-side-base-count', 'null')
new_model_types = c('1x2DNA-shape', '1x2motif', 'categorical-distance', 'linear-distance', 'two-side-base-count', 'null')
