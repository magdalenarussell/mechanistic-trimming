...
fwrite(coefs, paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/motif_base_count_model/coefs.tsv'), sep = '\t')
...
# isolate legend
legend = get_legend(v_base_count_heatmap) 
...
all = align_plots(v_motif_heatmap, j_motif_heatmap, v_base_count_heatmap, j_base_count_heatmap, legend, align = 'vh', axis = 'lbr')
...
together = plot_grid(first_grid, NULL, second_grid, NULL, legend, nrow = 5, rel_heights = c(1, 0.08, 1, 0.08, 0.2))

# save plot
file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/motif_base_count_model/coef_heatmap.pdf')
