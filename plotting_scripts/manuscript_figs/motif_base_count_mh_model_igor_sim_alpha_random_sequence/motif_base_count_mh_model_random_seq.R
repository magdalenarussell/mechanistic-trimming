...
fwrite(coefs, paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/motif_base_count_mh_model_igor_sim_alpha_random_sequence/coefs.tsv'), sep = '\t')
...
# save plot
file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/motif_base_count_mh_model_igor_sim_alpha_random_sequence/coef_heatmap_random_seq.pdf')
