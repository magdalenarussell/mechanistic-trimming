...
# save plot
file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/motif_base_count_mh_model_igor_sim_alpha_independent_vj/coef_heatmap_independent_vj.pdf')
