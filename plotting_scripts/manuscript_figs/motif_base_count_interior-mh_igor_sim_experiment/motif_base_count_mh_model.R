...
fwrite(coefs, paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/motif_base_count_interior-mh_igor_sim_experiment/coefs.tsv'), sep = '\t')
...
# save plot
file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/motif_base_count_interior-mh_igor_sim_experiment/coef_heatmap.pdf')
