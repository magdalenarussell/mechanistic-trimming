...
for (param in LIGATION_PARAMS){
    ...
    fwrite(coefs, paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/mh_simulator_experiments/baseline_igor_ligation-mh_trims_from_motif_base-count_VJ_dependence_experiment/coefs_MHprob', param, '.tsv'), sep = '\t')
    ...
    # save plot
    file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/mh_simulator_experiments/baseline_igor_ligation-mh_trims_from_motif_base-count_VJ_dependence_experiment/coef_heatmap_MHprob', param, '.pdf')
