...
fwrite(coefs, paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/mh_simulator_experiments/motif_base_count_ligation-mh_trims_from_uniform_tips_experiment/coefs_MHprob', LIGATION_PARAMS, '_', TRIMMING_PROB_MODEL, '_trim-model.tsv'), sep = '\t')
...
# save plot
file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/mh_simulator_experiments/motif_base_count_ligation-mh_trims_from_uniform_tips_experiment/coef_heatmap_', TRIMMING_PROB_MODEL, '_trim-model.pdf')
