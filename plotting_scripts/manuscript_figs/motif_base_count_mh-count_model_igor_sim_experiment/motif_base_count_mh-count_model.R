...
MODEL_TYPE <<- 'motif_two-side-base-count-beyond_mh-count'
...
# save plot
file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/motif_base_count_mh-count_model_igor_sim_experiment/coef_heatmap.pdf')
