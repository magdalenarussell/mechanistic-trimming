...
igor -threads $NCPU -set_wd $OUTPUT_DIR -batch foo -species human -chain beta -align --all
...
igor -threads $NCPU -set_wd $OUTPUT_DIR -batch foo -species human -chain beta -evaluate -output --scenarios $ANNOTATION_COUNT 
