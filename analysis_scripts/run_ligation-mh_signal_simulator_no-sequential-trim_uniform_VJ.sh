...
Rscript $PWD/mechanistic-trimming/analysis_scripts/ligation-mh_signal_simulator_no-sequential-trim_uniformVJ/process_data_for_ligation-mh_signal_simulation.R $NCPU $TRIM_SAMPLING_TYPE $LIGATION_MH_PARAM
