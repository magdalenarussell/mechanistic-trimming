...
Rscript $PWD/mechanistic-trimming/analysis_scripts/ligation-mh_signal_simulator/process_data_for_ligation-mh_signal_simulation.R $PARAM_GROUP $NCPU $TRIM_SAMPLING_TYPE $LIGATION_MH_PARAM
