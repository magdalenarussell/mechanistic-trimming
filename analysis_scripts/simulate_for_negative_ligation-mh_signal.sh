...
path=$(Rscript $PWD/mechanistic-trimming/analysis_scripts/draw_configs_from_motif_two-side-base-count-beyond/process_data_for_negative_ligation-mh_signal_simulation.R)
...
Rscript $PWD/mechanistic-trimming/analysis_scripts/draw_configs_from_motif_two-side-base-count-beyond/simulate_data_for_negative_ligation-mh_signal_simulation.R
