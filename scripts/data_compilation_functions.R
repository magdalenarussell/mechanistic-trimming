...
get_subject_motif_output_location <- function(){
    output_location = file.path(OUTPUT_PATH, TRIM_TYPE, paste0(MOTIF_TYPE))
...
source(paste0('scripts/gene_weight_functions/', GENE_WEIGHT_TYPE, '.R'))
...
# TODO move these functions to a different file, under the groups?
