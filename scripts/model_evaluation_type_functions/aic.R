...
evaluate_loss <- function(motif_data) {
    ...
    # compute aic 
    aic = 2*nrow(motif_data)*log_loss + 2*parameter_count
    return(list(loss = aic, model_parameter_count = parameter_count, held_out_cluster_number = NA, held_out_genes = NA))
}
