...
get_model_formula <- function(){
    formula = formula(paste0('cbind(weighted_observation, interaction(gene, subject)) ~ right_terminal_melting_score + left_terminal_melting_score + as.factor(trim_length)'))
    return(formula)
}
